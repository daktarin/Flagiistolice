...
public class DataBaseHelperPowtorki_DE extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "powtorki_de.db";
    public static final String TABLE_NAME = "powtorki_table_de";
    ...
    public DataBaseHelperPowtorki_DE(Context context) {
