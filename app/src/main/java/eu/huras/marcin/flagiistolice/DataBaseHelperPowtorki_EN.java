...
public class DataBaseHelperPowtorki_EN extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "powtorki_en.db";
    public static final String TABLE_NAME = "powtorki_table_en";
    ...
    public DataBaseHelperPowtorki_EN(Context context) {
